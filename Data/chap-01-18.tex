...
\setlength{\hangindent}{52pt}{张苍\hspace{30pt}【{\akai 西皮快板}】吕后做事太欺情，不该宗卷备火焚({\akai 或}:可恨吕后心太狠，火焚宗卷谋乾坤)。({\akai 或}:~宗卷不该用火焚。)家院掌灯({\akai 或}:~家院向前)把路{\akai 引}，不觉来到相府门。}
...
\setlength{\hangindent}{52pt}{张苍\hspace{30pt}({\akai 内唱})【{\akai 西皮导板}】家院与爷({\akai 或}:~家院掌灯)把路{\akai 引}，}
...
\setlength{\hangindent}{52pt}{张苍\hspace{30pt}我有忏悔呀。({\akai 或}:~慢来慢来，我有忏悔啊。)}
