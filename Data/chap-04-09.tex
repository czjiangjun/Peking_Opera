\newpage
\subsubsection{\large\hei 探母回令\protect\footnote{陈超老师注:~谭鑫培的《四郎探母》一剧是与王君直交流最多的，并听取王君直的建议做了不少修改，做了很多独具匠心的身段设计。}~{\small 之}~杨延辉}
\addcontentsline{toc}{subsection}{\hei 探母回令~{\small 之}~杨延辉}
...
\setlength{\hangindent}{56pt}{(杨延昭\hspace{20pt}【{\akai 西皮摇板}】$\cdots{}\cdots{}$后帐未出来。) }
