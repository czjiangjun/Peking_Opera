...
\setlength{\hangindent}{52pt}{(\textless{}\!{\bfseries\akai 小开门}\!\textgreater{}，{\hwfs 下}，{\hwfs 再上})}
...
\setlength{\hangindent}{52pt}{\spacept{钟元普\footnote{钟元普亦作钟元甫，此处从李舒先生钞录稿。}}{16pt}({\akai 内白})走哇。}
...
\setlength{\hangindent}{52pt}{童~~~儿\hspace{20pt}~ 抓髻，白花褶子，鞋。 }
...
\setlength{\hangindent}{52pt}{(俞伯牙{\hwfs 念}``将摇琴摆在坟前$\cdots${}$\cdots${}''，渔、樵{\hwfs 内}``啊哈''\textless{}\!{\bfseries\akai 小锣五击}\!\textgreater{}{\hwfs 上})}
