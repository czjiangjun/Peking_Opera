...
{俺伍员好比淤泥\textcolor{red}{污}住车}\footnote{李元皓{\scriptsize 君}建议此处作``误驻车''。据樊百乐{\scriptsize 君}告，刘曾复先生确认该字为``污(\textrm{w\`u})''，表示泥泞的东西将车轮胶着住了。姜骏按:~此处用``淤''字文意最准确，这个字在南方客家方言中仍保留有念\textrm{w\=u}音的。}{，沙滩------困蛟龙。}
