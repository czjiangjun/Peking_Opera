...
\section*{\large\hei (安居)平五路~\protect\footnote{根据刘曾复先生钞本整理，刘曾复先生说戏``平五路''是本剧的``观鱼遣邓''部分。刘曾复先生的钞本与《清车王府藏曲本(全印本)》\upcite{CWFCQB}第二册所收录的``安五路(总讲)''基本一致，但``安五路(总讲)''没有最后的``邓芝扑油鼎''部分。}}
