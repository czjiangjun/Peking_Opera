\newpage
\subsubsection{\hei\large 蟠桃会~\protect\footnote{此戏别名《海屋添筹》或《八仙庆寿》，是一出武旦戏。}~%\protect\hyperlink{fn632}{\textsuperscript{632}}
{\small 之}~吕洞宾$^{\ast}$}
\addcontentsline{toc}{subsection}{\hei 蟠桃会~{\small 之}~吕洞宾}
...
``坎''(\includegraphics[height=12pt,width=12pt, viewport=120 59 225 140,clip]{Eight_Gua.jpeg})为水，
``离''(\includegraphics[height=12pt,width=12pt, viewport=5 59 100 140,clip]{Eight_Gua.jpeg})为火。此处寓为``水火既济''之意。}%\protect\hyperlink{fn635}{\textsuperscript{635}}
...
(李铁拐\hspace{15pt}~ 【{\akai 西皮散板}】$\cdots${}$\cdots${}\textrm{入东海道，)}
