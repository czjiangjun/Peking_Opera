...
\setlength{\hangindent}{65pt}{   %3. 设置悬挂缩进量                %
	(卫云环\hspace{15pt}~ 【{\akai 二黄慢板}】此时间讲什么粉消香散，进寝宫({\akai 或}:~进宫去)愿母后免去心酸。\footnote{``粉消香散''四字从刘曾复先生存本，当系准词，说戏录音作``焚烧香泛''，李楠{\scriptsize君}以为作``焚烧香饭''，香饭是佛家饭食。存本上注``霎时间说不尽风流云散，进宫来见母后心内痛酸。''}%\protect\hyperlink{fn21}{\textsuperscript{21}}
)
}
