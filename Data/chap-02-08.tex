...
(关黄{\hwfs 开打}，{\hwl 一合}，关{\hwfs 小边}，黄{\hwfs 大边}，{\hwl 一拉转身}，{\hwl 架住往里一绕两绕三绕}，{\hwl 往外一绕两绕三绕}，黄{\hwl 压}关{\hwl 刀}，关{\hwl 撤刀}，{\hwl 用刀鐏盖}黄{\hwl 刀头}，{\hwl 鼻子}，{\hwl 削头}。黄{\hwfs 败下}，关{\hwfs 追下})
