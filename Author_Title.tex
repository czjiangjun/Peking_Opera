...
%\centering
%\hspace*{4.5in}
%\includegraphics[height=1.30\textwidth,width=0.26\textwidth,viewport=0 0 620 2850,clip]{Figures_Peking-Opera/Liu_script-Inscription.JPG}
%%\caption*{\hei 陈佩秋(谢稚柳~夫人)先生~题签}
%\label{Chen-Peking_Opera_Script-Inscription-2015}
%\end{figure}
\hei\Huge{刘曾复教授说戏剧本集(文稿)}
}
\author[]{}   %
