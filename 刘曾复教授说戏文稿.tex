...
\caption*{\hei 刘曾复~先生抄录的《取金陵》曹良臣的单词}
\label{Script}
\end{figure}
...
\begin{minipage}[t]{0.53\textwidth}
	...
	\caption*{\hei \fontsize{8.5pt}{4.0pt}\selectfont{左:~刘曾复~先生保存的部分说戏录音磁带}}
\end{minipage}
\hspace{0.6in}
\begin{minipage}[t]{0.43\textwidth}
	...
	\caption*{\hei \fontsize{8.5pt}{4.0pt}\selectfont{右:吴小如~先生保存的刘曾复先生的说戏录音磁带}}
\end{minipage}
\label{Records}
\end{figure}
